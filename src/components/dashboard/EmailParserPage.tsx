  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground text-sm mt-1">Paste an email to extract key information with AI</p>
      </div>
      ...
      {parsed && (
        <div className="glass-card p-6 mt-4 space-y-3">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex gap-2"><span className="text-muted-foreground w-28">Sender:</span><span>{parsed.sender}</span></div>
            <div className="flex gap-2"><span className="text-muted-foreground w-28">Intent:</span><span className="text-primary">{parsed.intent}</span></div>
            <div className="flex gap-2"><span className="text-muted-foreground w-28">Sentiment:</span><span>{parsed.sentiment}</span></div>
            <div className="flex gap-2"><span className="text-muted-foreground w-28">Priority:</span>
            ...
            <div className="flex gap-2"><span className="text-muted-foreground w-28">Key Dates:</span>
              <span>{parsed.key_dates?.length ? parsed.key_dates.join(", ") : "None detected"}</span>
            </div>
